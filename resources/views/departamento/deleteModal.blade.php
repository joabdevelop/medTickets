<!-- Create Modal DELETE DEPARTAMENTO HTML -->
<div class="modal fade" id="deleteDepartamentoModal" tabindex="-1" role="dialog" aria-labelledby="deleteDepartamentoModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form name="deleteDepartamento" method="POST">
                @method('delete')
                @csrf
                ...
                <!-- Nome da Departamento -->
                <div class="modal-body ">

                    <input type="hidden" name="delete_id" id="delete_id" />
                    <div class="form-group">
                        <label>Confirmar a exclusão do Departamento:</label>

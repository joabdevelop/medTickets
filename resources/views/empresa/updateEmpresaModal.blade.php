<!-- Create Modal UPDATE EMPRESA HTML -->
<div class="modal fade" id="updateEmpresaModal" tabindex="-1" role="dialog" aria-labelledby="updateEmpresaModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content ">
            ...
            <form method="POST" action="" id="editForm">
                ...
                <div class="modal-body ">
                    <!-- Conteúdo do formulário (apenas exemplos ajustados; aplique o padrão a todos os campos) -->
                    <div class="container">
                        <!-- Primeira div -->
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    ...
                                    <input id="nome_fantasia" type="text" oninput="capitalizeInput(this)"
                                        ...
                                        name="nome_fantasia" required autofocus>
                                    @error('nome_fantasia')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="ultima_renovacao_contrato" type="date"
                                        class="form-control @error('ultima_renovacao_contrato') is-invalid @enderror"
                                        name="ultima_renovacao_contrato">
                                    @error('ultima_renovacao_contrato')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    @enderror

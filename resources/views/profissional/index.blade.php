    ...
    @push('scripts')
     <script>
         ...
         $(document).on('change', '.status-toggle', function(e) {
             ...
             $('#status_id').val(id);
             $('#status_nome').text(nome);

             if (status == 1) {
                 msg = 'O profissional será inativado e não poderá mais acessar o sistema.';
                 classe = 'text-danger';
             } else {
                 msg = 'O profissional será ativado e poderá acessar o sistema.';
                 classe = 'text-success';
             }

             $('#status-msg').text(msg).removeClass('text-danger text-success').addClass(classe);

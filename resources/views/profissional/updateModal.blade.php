...
<div class="modal fade" id="updateProfissionalModal" tabindex="-1" role="dialog"
    aria-labelledby="updateProfissionalModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="container form-cadastro">
                        ...
                        <div class="form-group mt-4">
                            ...
                            <input type="text" class="form-control" name="update_nome" id="update_nome"
                                value="" required>
                        </div>
                        ...
                        <div class="form-group mt-4">
                            ...
                            <input type="tel" class="form-control" name="update_telefone" id="update_telefone"
                                value="" required>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mt-4 col-md-6">
                                ...
                                <select name="update_tipo_usuario" class="form-select form-control"
                                    id="update_tipo_usuario">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="form-group mt-4 col-md-6">
                                ...
                                <select name="update_departamento" class="form-select form-control"
                                    id="update_departamento">
                            ...
                            <div class="form-group mt-4 col-md-6">
                                ...
                                <select name="update_tipo_acesso" class="form-select form-control"
                                    id="update_tipo_acesso">

            ...
            <form name="createGrupo" method="POST" action="{{ route('solicitaServico.store') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-cadastro">
                        ...
                        <input type="hidden" class="form-control" id="create_user_departamento" name="create_user_departamento" />
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mb-3 col-md-6 ">
                                <label for="create_user_id_solicitante_display" class="form-label">Nome do Solicitante</label>
                                <input type="text" class="form-control" id="create_user_id_solicitante_display" value="{{ Auth::user()->name ?? 'Usuário Autenticado' }}" readonly>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control @error('data_solicitacao') is-invalid @enderror" id="create_data_solicitacao" name="data_solicitacao" value="{{ old('data_solicitacao', now()->toDateString()) }}" readonly>
                            </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select id="create_tipo_servico_id" name="tipo_servico_id" class="form-select form-control" required>
                        ...
                        <div class="form-group mb-3">
                            <label id="label_descricao_servico" class="fs-5 form-label mb-2" for="create_descricao_servico">Aguardando a seleção...</label>
                            <textarea
                                maxlength="2000"
                                placeholder="Descrição do Serviço..."
                                class="form-control @error('descricao_servico') is-invalid @enderror"
                                id="create_descricao_servico"

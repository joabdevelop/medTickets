<x-app-layout title="Solicita Serviço">
            ...
            <div class="container-list">
                ...
                <form method="GET" action="{{ route('solicitaServico.index') }}" class="input-group w-25">
                    ...
                    <input
                        ...
                        placeholder="Digite o numero do ticket"
                        aria-label="Buscar">
                ...
                <button
                    ...
                    data-bs-target="#createSolicitaServicoModal"
                ...
                <table class="table table-hover cursor-pointer table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $solicitaServico->status_final }}</td>
                            <td>
    ...
    @push('scripts')
    <script>
        window.service = {!!json_encode($tiposServicos) !!};
        const servicos = window.service || [];
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.body.addEventListener('click', function(e) {
                ...
                // Verifica se o elemento clicado corresponde ao seletor '.create'
                ...
                // Verifica se o elemento clicado corresponde ao seletor '.update'
                ...
                if (updateButton) {
                    ...
                    //document.getElementById('update_data_solicitacao').value = dataSolicitacao.format('dd-MM-yyyy');
                    ...
                    document.getElementById('update_status_final').value = statusFinal;
                    document.getElementById('update_numero_ticket').textContent = numeroTicket;
                    document.getElementById('update_numero_ticket1').value = numeroTicket;
                    ...
                    if (form) {
                        form.action = '{{ route("solicitaServico.update", ":id") }}'.replace(':id', userId);

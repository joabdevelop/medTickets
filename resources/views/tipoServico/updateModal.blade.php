                        ...
                        <div class="modal-body">
                            ...
                            <div class="row form-cadastro">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="update_nome_servico" id="update_nome_servico" required value="{{ old('update_nome_servico') }}">
                                </div>

                                <!-- nome da solicitacao -->
                                <div class="form-group mt-2">
                                    <label class="form-label mb-0">Titulo da solicitação:</label>
                                    <input type="text" class="form-control" name="update_titulo_nome" id="update_titulo_nome" rows="3" required>
                                </div>

                                <div class="form-group mt-2">
                                    <label>Prioridade:</label>
                                    <select name="update_prioridade" id="update_prioridade" class="form-select form-control" required>
                                ...
                                <div class="form-group mt-2 mb-2">
                                    ...
                                    <select name="update_quem_solicita" id="update_quem_solicita" class="form-select form-control" required>
                                        <option value="" disabled selected>Selecione</option>
